...
My `noodle` theme is available on [github](https://github.com/benharrap/rsthemes) if you want to use it yourself. I'm solidly in my pastel pink era at the moment so I created the theme with that in mind. If you're wondering why it's called noodle, I was wearing a pastel pink t-shirt with a greyhound on it today ([this one if you must know](https://everpress.com/i-can-fly)) and noodle is a silly nickname for greyhounds. Below are a couple of previews of what the theme looks like.
