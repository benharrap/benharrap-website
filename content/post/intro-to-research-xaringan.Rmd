...
subtitle: 'Research on the Run 2021, Ballarat Health Services'
author: 'Ben Harrap'
output:
...
knitr::include_graphics("https://benharrap.com/img/intro-to-research/collaboration.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/talk1.png")
```

Here's a broad overview of the research process.
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/talk2.png")
```

Often, people come to me after they've already collected their data, wanting help with analysis.
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/talk3.png")
```

If you come to me only at the data analysis stage, the chances of me being able to help are low! 
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/talk4.png")
```

Come and see me before then.
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/step1.png")
```
...
<p style="font-size: 32px;">Is a pedometer and activity coaching intervention effective in limiting gestational weight gain in obese pregnant women compared to a pedometer with self-managed activity over the course of their pregnancy.</p>

---

## PICOT example - Population

<p style="font-size: 32px;">Is a pedometer and activity coaching intervention effective in limiting gestational weight gain in <strong>obese pregnant women</strong> compared to a pedometer with self-managed activity over the course of their pregnancy.</p>

---

## PICOT example - Intervention

<p style="font-size: 32px;">Is a <strong>pedometer and activity coaching intervention</strong> effective in limiting gestational weight gain in obese pregnant women compared to a pedometer with self-managed activity over the course of their pregnancy.</p>
  
---

## PICOT example - Comparator
  
<p style="font-size: 32px;">Is a pedometer and activity coaching intervention effective in limiting gestational weight gain in obese pregnant women compared to <strong>a pedometer with self-managed activity</strong> over the course of their pregnancy.</p>
  
---

## PICOT example - Outcome

<p style="font-size: 32px;">Is a pedometer and activity coaching intervention effective in limiting <strong>gestational weight gain</strong> in obese pregnant women compared to a pedometer with self-managed activity over the course of their pregnancy.</p>
  
---

## PICOT example - Timeframe

<p style="font-size: 32px;">Is a pedometer and activity coaching intervention effective in limiting gestational weight gain in obese pregnant women compared to a pedometer with self-managed activity <strong>over the course of their pregnancy</strong>.</p>
...
<strong>Experimental studies:</strong>
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/step2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/protocol.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/step3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/step4.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-4.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-5.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-6.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-7.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data1-8.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/data2.png")
```
...
library(tidyverse)
library(kableExtra)
col1 <- c("id","group","bmi_baseline","bmi_followup","drug","dose","frequency")
col2 <- c("","","kg/m^2","kg/m^2","","mg","")
col3 <- c("1 to 8","1 to 2","10 to 50","10 to 50","Rosuvastatin, Atorvastatin","5 to 20","1x daily to 3x daily")
col4 <- c("Unique identifier for each participant","Participant's randomly allocated group", "Participant's BMI at baseline","Participant's BMI at the study endpoint","Brand of statin administered","Prescribed dosage in mg of the medication","Prescribed frequency of the medication")
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/step5.png")
```
...
Like baking, we might set out to make the perfect cake

```{r, echo=FALSE, out.width="40%"}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/hog3.jpg")
```
...
By coming to me early we can avoid disasters...

```{r, echo=FALSE, out.width="40%"}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/hog1.jpg")
```
...
And create something pretty reasonable instead!

```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/hog2.jpg")
```
...
- Consider the feasibility of the sample size.
  - Do you have the time or staff to be able to recruit and process the number of participants needed?
- Costs of recruiting participants. 
  - A basic estimate might say you need to recruit more participants that you have funding for.
- Consider prior research.
  - Considering what previous studies have found is a good place to start for thinking how much of an effect you think a treatment might have.
- Consider clinical significance.
  - How much of a change would we need to see in your outcome to make a case for changing practice?
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/dag1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/dag2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/dag3.png")
```
...
- Isabella Ghement (@IsabellaGhement)
...
If you want some more topics to go and read up on, check out my tweet:

https://twitter.com/BHarrap/status/1443784159168663571

```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("https://benharrap.com/img/intro-to-research/tweet.png")
```

And for more reading on 'common statistical myths' see https://discourse.datamethods.org/t/reference-collection-to-push-back-against-common-statistical-myths/1787