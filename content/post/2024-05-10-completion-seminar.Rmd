...
include_graphics("img/completion-seminar/paper_1.PNG")
```
...
```{r, out.width="70%"}
include_graphics("img/completion-seminar/cps_all.pdf")
```

## Cumulative incidence of first contacts with CPS, 2000 to 2015, by year of birth

```{r, out.width="70%"}
include_graphics("img/completion-seminar/cps_year.pdf")
```

## Siblings

```{r, out.width="50%"}
include_graphics("img/completion-seminar/cps_family.png")
```
...
```{r, out.width="80%"}
include_graphics("img/completion-seminar/cps_sib.pdf")
```
...
```{r, out.width="60%"}
include_graphics("img/completion-seminar/hp_cond.pdf")
```
...
```{r, out.width = "80%"}
include_graphics("img/completion-seminar/margins_ra.png")
```

## Marginal rates per 100,000 days at risk by condition

```{r, out.width = "80%"}
include_graphics("img/completion-seminar/margins_diag.png")
```
