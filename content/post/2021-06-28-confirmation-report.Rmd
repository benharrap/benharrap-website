...
```{r, fig.cap="An overview of the child protection system in Western Australia", echo=FALSE, out.width="100%"}
knitr::include_graphics('../../static/img/confirmation-report/system-overview.png')
```
