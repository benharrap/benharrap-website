...
tibble(
  ...
  Note = "`mutate` and overwrites variables without warning, unlike Stata"
) |> 
  add_row(
...
tibble(
  ...
  add_row(
    ...
    Note = "To run these examples, you'd first need to create `rep79`, which I created as `rep78+1`"
  ) |>
  add_row(
